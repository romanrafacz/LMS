...
class ClassPlSummary(models.Model):
    ...
    facility_expense = models.DecimalField(decimal_places=2)
    material_expense = models.DecimalField(decimal_places=2)
    lab_expense = models.DecimalField(decimal_places=2)
    travel_expense = models.DecimalField(decimal_places=2)
    instructor_expense = models.DecimalField(decimal_places=2)
    other_expense = models.DecimalField(decimal_places=2)
    total_expense = models.DecimalField(decimal_places=2)
    class_prce = models.DecimalField(decimal_places=2)
    total_attend = models.IntegerField()
    total_jmw_attend = models.IntegerField()
    gross_receipts = models.DecimalField(decimal_places=2)
    net_profit = models.DecimalField(decimal_places=2)
    gross_jmw_receipts = models.DecimalField(decimal_places=2)
    po = models.CharField(max_length=50)
    currency = models.CharField(max_length=50)
    instructor_rate = models.DecimalField(decimal_places=2)
    net_profit = models.DecimalField(decimal_places=2)

clas JMWClassInfo(models.Model):
    jmw_class_info_id = models.IntegerField()
